...
We have chosen these values because we felt it has the best trade-off in enhancing areas that were less visible while not overexposing values that already had a high intensity.
\begin{figure}[!Htb]
 \centering
